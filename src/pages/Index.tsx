    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="text-center py-8 px-4 relative z-10">
        ...
        <div className="flex justify-center mt-6 space-x-4">
          <Button variant="default" asChild className="bg-whatsapp-green hover:bg-whatsapp-green/90 shadow-lg">
      ...
      <main className="flex-grow container max-w-xl px-4 py-8 relative z-10">
        ...
        <div className="mt-12 bg-gradient-to-br from-[#075e54]/80 to-[#128c7e]/80 backdrop-blur-md p-6 rounded-xl border border-white/10 shadow-lg">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center justify-center gap-2">
            <Info className="w-5 h-5 text-whatsapp-green" />
            How it works
          </h2>
          <ol className="list-none text-left space-y-4 text-white/90">
            {[
              "Enter a phone number with country code (e.g., +60123456789)",
              ...
              <li key={index} className="flex gap-3 items-start">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-whatsapp-green flex items-center justify-center text-white font-bold">
                  {index + 1}
                </div>
                <span>{step}</span>
              </li>
